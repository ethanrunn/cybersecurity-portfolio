(function($) {
    ...
    $(document).ready(function() {
        $(".work-carousel").owlCarousel({
            ...
            responsive: {
                0: { items: 1 }, // 1 item per slide for mobile
                768: { items: 1 }, // 1 items per slide for tablets
                1024: { items: 2 } // 2 items per slide for desktops
            }
        });
    });
